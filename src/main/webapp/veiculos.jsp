                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group row" >
                                            <label for="inputEmail3" class="col-md-3 col-form-label"> Nome: </label>

                                            <div class="input-daterange input-group col-md-9" id="daterangepicker">
                                                <input class="form-control input-daterange-timepicker" name="nome" type="text" autocomplete="off">
                                            </div>
                                        </div>

                                        <div class="form-group row" name="nome">
                                            <label for="inputEmail3" class="col-md-3 col-form-label"> Montadora: </label>
                                        ...
                                        <div class="form-group row" name="nome">
                                            <label for="inputEmail3" class="col-md-3 col-form-label"> Ano: </label>
                                        ...
                                        <div class="form-group row" name="nome">
                                            <label for="inputEmail3" class="col-md-3 col-form-label"> Placa: </label>
                                        ...
                                        <div class="form-group row" name="nome">
                                            <label for="inputEmail3" class="col-md-3 col-form-label"> Renavam: </label>
                                        ...
                                        <div class="form-group row">
                                            <label for="servico" class="col-3 col-form-label">Combustível: </label>

                                            <div class="col-md-9">
                                                <select name="servico" id="servico">
                                                    <option value="0">Gasolina</option>
                                                    <option value="1">Álcool/Etanol</option>
                                        ...
                                        <div class="form-group row">
                                            <label for="operador" class="col-3 col-form-label">Câmbio: </label>
